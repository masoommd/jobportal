      ...
      <div>
        ...
        <div className="flex items-center gap-5 p-8">
            <Button
              ...
              className="flex items-center gap-2 font-semibold rounded-xl text-gray-500 bg-gray-100"
            >
              <ArrowLeft />
              <span>Back</span>
            </Button>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {
              companies.length > 0 && (
                <Select value={singleJob?.company?.name.toLowerCase()} onValueChange={selectChangeHandler}>
                  <SelectTrigger>
