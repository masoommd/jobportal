...
export default function Footer() {
    return (
        <footer className="bg-gray-200 border-t-4">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to="/" className="flex items-center text-red-500">
                            {/* <Logo/> */}
                            <span className='font-bold text-2xl text-black'>Job<span className="text-[#F83002] ">Spark</span></span>
                        </Link>
                    </div>
                ...
                <hr className="my-6 text-gray-900 sm:mx-auto lg:my-8" />
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-900 sm:text-center">
                        © 2025 Md Masoom All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        <Link to="https://www.facebook.com/masoom.alam.182/" className="text-gray-900 hover:text-gray-700">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
                        ...
                        <Link to="https://discord.gg/eKQd4zPP" className="text-gray-900 hover:text-gray-700">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <Link to="https://x.com/masoom9262" className="text-gray-900 hover:text-gray-900">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <Link to="https://github.com/masoommd" className="text-gray-900 hover:text-gray-700">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <Link to="https://www.linkedin.com/in/mdmasoom459/" className="text-gray-900 hover:text-gray-700">
                        <svg 
                        className="w-4 h-4"
                        aria-hidden="true"
                         viewBox="0 0 20 20" 
